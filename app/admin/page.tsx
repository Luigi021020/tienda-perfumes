    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="bg-zinc-900 border-b border-zinc-800 px-6 py-4 flex justify-between items-center">
        <div>
          ...
          <p className="text-zinc-500 text-xs tracking-wider">Panel Administrativo</p>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-zinc-400 text-sm">{session.user?.name}</span>
          
            <a href="/api/auth/signout"
            className="text-xs text-zinc-500 hover:text-yellow-500 transition-colors uppercase tracking-wider"
          >
            Cerrar sesion
          </a>
        </div>
      ...
      <main className="p-6 max-w-7xl mx-auto">
        ...
        {/* Fila inferior: últimos pedidos y stock bajo */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5">
            ...
            {ultimosPedidos.length === 0 ? (
              <p className="text-zinc-600 text-sm">No hay pedidos aún</p>
            ) : (
                ...
                {ultimosPedidos.map((pedido) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      {/* Etiqueta de estado con color según el estado */}
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5">
            ...
            {stockBajo.length === 0 ? (
              <p className="text-zinc-600 text-sm">Todo el inventario está bien</p>
            ) : (
              <div className="space-y-3">
